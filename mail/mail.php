...
$recipientEmail             = 'somatic.education@gmail.com '; // REQUIRED value.
$recipientName              = 'Christos Noulis';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Somatics for Musicians ©'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'somaticsformusicians.com';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone                   = 'Europe/Athens';         // OPTIONAL, but some servers require this to be set. 
